function pcStore(input) {
    ...
    let priceForCpuAfterDiscount = cpuPriceInLv - (cpuPriceInLv * discountPercent);
    let priceForVideoCardAfterDiscount = videoCardPriceInLv - (videoCardPriceInLv * discountPercent);
    
    let totalPrice = priceForCpuAfterDiscount + priceForVideoCardAfterDiscount + totalRamPrice
