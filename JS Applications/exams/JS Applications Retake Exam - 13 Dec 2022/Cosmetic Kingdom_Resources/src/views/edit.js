...
import { getById, updateProduct } from '../data/offers.js';
    ...
    <section id="edit">
        <div class="form">
            ...
            <form class="edit-form" @submit=${onEdit}>
                ...
                <textarea id="product-description" name="description" .value=${product.description} placeholder="Description" rows="5"
                    cols="50"></textarea>
